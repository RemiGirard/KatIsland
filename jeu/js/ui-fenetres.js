...
(function () {
  ...
  const MINE_IMG='img/interface/mine/';
  const MINE_ART={filon_fer:'fer.png',veine_charbon:'charbon.png',filon_cuivre:'cuivre.png',filon_etain:'etain.png',filon_argent:'argent.png',filon_or:'or.png',galerie_profonde:'galerie.png',laver_minerai:'laverie.png',ventiler_mine:'ventilation.png',etayer_mine:'soutien.png',mine:'chevalement.png',ventilation:'ventilation.png',air:'air-vicie.png',soutien:'soutien.png',eboulement:'eboulement.png',profondeur:'profondeur.png',lampe:'lampe.png',laverie:'laverie.png',maitrise:'maitrise.png'};
  const CHARBONNIERE_IMG='img/interface/charbonniere/';
  const CHARBONNIERE_ART={cuire_charbon:'charbon.png',bois:'bois.png',charbon:'charbon.png',cendre:'cendre.png',meule:'meule.png',froide:'froide.png',ideale:'ideale.png',chaude:'chaude.png',incendie:'incendie.png',ferme:'event-ferme.png',moyen:'event-moyen.png',ouvert:'event-ouvert.png',temperature:'temperature.png',sceller:'sceller.png',precoce:'precoce.png',complete:'mature.png',maitrise:'maitrise.png'};
  const TUILERIE_IMG='img/interface/tuilerie/';
  const TUILERIE_ART={preparer_fournee:'melange.png',cuire_brique:'briques.png',cuire_tuile:'tuiles.png',torchis:'argile.png',poterie:'four.png',cuire_chaux:'cuisson.png',argile:'argile.png',melange:'melange.png',briques:'briques.png',tuiles:'tuiles.png',four:'four.png',legere:'charge-legere.png',dense:'charge-dense.png',cuisson:'cuisson.png',froid:'froid.png',ideal:'ideal.png',surchauffe:'surchauffe.png',refroidissement:'refroidissement.png',sechoir:'sechoir.png',moule:'moule.png',economie:'economie.png',maitrise:'maitrise.png'};
  const POTERIE_IMG='img/interface/poterie/';
  const POTERIE_ART={tourner_pot:'argile-tour.png',cuire_pots:'four.png',fournee_gres:'gres.png',jarres_marchandes:'amphore.png',grand_vaisselier:'tour-pied.png',email_cuivre:'email-cuivre.png',etamer:'etain.png',argile:'argile-tour.png',pot:'pot-simple.png',gres:'gres.png',amphore:'amphore.png',tour:'tour-pied.png',email:'email-cuivre.png',etain:'etain.png',four:'four.png',sechoir:'sechoir.png',casse:'casse.png',parfaite:'piece-parfaite.png',formes:'formes.png',outils:'outils.png',glacure:'glacure.png',empilement:'empilement.png',maitrise:'maitrise.png'};
  const VERRERIE_IMG='img/interface/verrerie/';
  const VERRERIE_ART={souffler_verre:'fusion.png',souffler_fiole:'fioles.png',vitrail:'vitrail.png',verre_argent:'miroir.png',sable:'sable.png',fusion:'fusion.png',verre:'verre.png',fioles:'fioles.png',vitrail:'vitrail.png',miroir:'miroir.png',four:'four.png',canne:'canne.png',froid:'froid.png',ideal:'ideal.png',surchauffe:'surchauffe.png',defauts:'defauts.png',recuit:'recuit.png',additifs:'additifs.png',creusets:'creusets.png',maitrise:'maitrise.png'};
  const FONDERIE_IMG='img/interface/fonderie/';
  const FONDERIE_ART={couler_fer:'fer.png',couler_cuivre:'cuivre.png',couler_bronze:'bronze.png',couler_acier:'acier.png',couler_argent:'argent.png',couler_or:'or.png',fondre_mithril:'mithril.png',refondre_limaille:'limaille.png',purger_four:'purge.png',fer:'fer.png',cuivre:'cuivre.png',bronze:'bronze.png',acier:'acier.png',argent:'argent.png',or:'or.png',mithril:'mithril.png',limaille:'limaille.png',four:'four.png',bain:'bain.png',scories:'scories.png',propre:'creuset-propre.png',soufflet:'soufflet.png',moules:'moules.png',purge:'purge.png',maitrise:'maitrise.png'};
  const FORGE_IMG='img/interface/forge/';
  const FORGE_ART={clouterie:'clouterie.png',outil_fer:'outil-fer.png',outil_acier:'outil-acier.png',forger_arme:'arme.png',ferrures:'ferrures.png',martinet_barres:'martinet.png',clous:'clouterie.png',outil:'outil-fer.png',acier:'outil-acier.png',arme:'arme.png',ferrures:'ferrures.png',martinet:'martinet.png',foyer:'foyer.png',enclume:'enclume.png',froid:'froid.png',ideal:'ideal.png',surchauffe:'surchauffe.png',trempe:'trempe.png',rythme:'rythme.png',precision:'precision.png',commandes:'commandes.png',maitrise:'maitrise.png'};
  const ARMURERIE_IMG='img/interface/armurerie/';
  const ARMURERIE_ART={forger_armure:'harnois.png',forger_ecu:'ecu.png',maille_acier:'maille.png',ecailler_harnois:'ecailles.png',harnois_bronze:'bronze.png',recycler_chutes_armure:'chutes.png',harnois:'harnois.png',ecu:'ecu.png',maille:'maille.png',ecailles:'ecailles.png',bronze:'bronze.png',patron:'patron.png',mannequin:'mannequin.png',rivets:'rivets.png',leger:'leger.png',equilibre:'equilibre.png',lourd:'lourd.png',mesures:'mesures.png',commandes:'commandes.png',heaume:'heaume.png',chutes:'chutes.png',maitrise:'maitrise.png'};
  const ORFEVRE_IMG='img/interface/orfevre/';
  const ORFEVRE_ART={monnayer:'monnaie.png',joaillerie:'bijou.png',sertir:'relique.png',couler_cloche:'cloche.png',collier_perles:'perles.png',polir_outils_orfevre:'polissage.png',monnaie:'monnaie.png',bijou:'bijou.png',relique:'relique.png',cloche:'cloche.png',perles:'perles.png',balance:'balance.png',sertissage:'sertissage.png',four:'four.png',prudent:'prudent.png',equilibre:'equilibre.png',audacieux:'audacieux.png',casse:'gemme-cassee.png',polissage:'polissage.png',tri:'tri-gemmes.png',coffre:'coffre.png',maitrise:'maitrise.png'};
  ...
  function artMine(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:MINE_IMG+(MINE_ART[id]||MINE_ART.mine);}
  function artCharbonniere(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:CHARBONNIERE_IMG+(CHARBONNIERE_ART[id]||CHARBONNIERE_ART.meule);}
  function artTuilerie(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:TUILERIE_IMG+(TUILERIE_ART[id]||TUILERIE_ART.four);}
  function artPoterie(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:POTERIE_IMG+(POTERIE_ART[id]||POTERIE_ART.pot);}
  function artVerrerie(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:VERRERIE_IMG+(VERRERIE_ART[id]||VERRERIE_ART.four);}
  function artFonderie(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:FONDERIE_IMG+(FONDERIE_ART[id]||FONDERIE_ART.four);}
  function artForge(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:FORGE_IMG+(FORGE_ART[id]||FORGE_ART.foyer);}
  function artArmurerie(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:ARMURERIE_IMG+(ARMURERIE_ART[id]||ARMURERIE_ART.harnois);}
  function artOrfevre(id){const r=window.REC&&window.REC[id];return r&&r.image?r.image:ORFEVRE_IMG+(ORFEVRE_ART[id]||ORFEVRE_ART.balance);}
  ...
  function rendreMineChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b),prof=G.profondeurMine(b);
    c.appendChild(el('section',{class:'scierie-maitrise mine-maitrise'},el('img',{src:artMine('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE MINIÈRE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:Math.round(prof)+' m'}),el('span',{text:'profondeur'}))));
    c.appendChild(el('section',{class:'mine-galeries'},el('img',{src:artMine(s.ventilation<25?'air':'galerie_profonde'),alt:''}),el('div',{},el('div',{class:'rangee entre'},el('b',{text:'Ventilation'}),el('strong',{text:Math.round(s.ventilation)+' %'})),U.barre(s.ventilation/100,s.ventilation<20?'rouge':'verte','Air',s.ventilation<12?'extraction suspendue':'baisse avec profondeur et effectifs'),el('div',{class:'rangee entre mine-jauge-titre'},el('b',{text:'Soutènement'}),el('strong',{text:Math.round(s.soutenement)+' %'})),U.barre(s.soutenement/100,s.soutenement<20?'rouge':'or','Boisages',s.soutenement<12?'galerie suspendue':'s’use à chaque lot profond'),el('div',{class:'mine-profondeur'},el('img',{src:artMine('profondeur'),alt:''}),el('span',{text:'Profondeur effective '+Math.round(prof)+' m · niveau '+b.niv})))));
    const strategies=[{id:'surface',nom:'Galeries hautes',art:'lampe',effet:'Minerais communs favorisés · air plus sûr'},{id:'equilibre',nom:'Descente régulière',art:'mine',effet:'Risques et filons équilibrés'},{id:'profonde',nom:'Descente profonde',art:'profondeur',effet:'Minerais avancés +24 % · sécurité exigeante',niv:4}],choix=el('div',{class:'scierie-organisations mine-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artMine(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Mine niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'Les postes de ventilation et d’étayage sont de vraies relèves de sécurité : laissez-les en boucle pour que les mineurs profonds s’arrêtent puis repartent sans intervention.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),toutes=window.BAT[b.type].recettes||[],liste=el('div',{class:'scierie-chaines mine-chaines'});for(const rid of toutes.filter(x=>disponibles.includes(x)))liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artMine,source:'galerie'}));for(const rid of toutes.filter(x=>!disponibles.includes(x)).slice(0,2))liste.appendChild(rendreLigneScierie(bid,rid,false,{art:artMine,source:'galerie'}));c.appendChild(liste);
  }

  function rendreCharbonniereChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b),seuil=s.politique==='precoce'?35:(s.politique==='complete'?90:64);
    c.appendChild(el('section',{class:'scierie-maitrise charbonniere-maitrise'},el('img',{src:artCharbonniere('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE CHARBONNIÈRE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:'×'+mult.toFixed(2)}),el('span',{text:'tirage'}))));
    const etat=s.temperature<42?'froide':(s.temperature>90?'incendie':(s.temperature>78?'chaude':'ideale')),event=s.ouverture<34?'ferme':(s.ouverture>67?'ouvert':'moyen');
    const reglage=el('label',{class:'charbonniere-event'},el('span',{text:'Ouverture des évents'}),el('input',{type:'range',min:'15',max:'90',value:String(Math.round(s.ouverture)),oninput:e=>{s.ouverture=Number(e.target.value);e.target.nextSibling.textContent=Math.round(s.ouverture)+' %';},onchange:()=>{window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}}),el('b',{text:Math.round(s.ouverture)+' %'}),el('img',{src:artCharbonniere(event),alt:''}));
    c.appendChild(el('section',{class:'charbonniere-meule'},el('img',{src:artCharbonniere(etat),alt:''}),el('div',{},el('div',{class:'rangee entre'},el('b',{text:'Température de la meule'}),el('strong',{text:Math.round(s.temperature)+' %'})),U.barre(s.temperature/100,s.temperature>92?'rouge':(s.temperature>=42&&s.temperature<=79?'verte':'or'),'Chaleur',s.temperature>94?'surchauffe : évents à fermer':'pilotée par les évents'),el('div',{class:'rangee entre charbonniere-jauge-titre'},el('b',{text:'Carbonisation'}),el('strong',{text:Math.round(s.maturation)+' / '+seuil})),U.barre(Math.min(1,s.maturation/seuil),s.maturation>=seuil?'verte':'','Meule',s.maturation>=seuil?'lot prêt à ouvrir':'mûrit automatiquement sous surveillance'),reglage)));
    const strategies=[{id:'precoce',nom:'Ouvrir tôt',art:'precoce',effet:'Lots fréquents · rendement réduit'},{id:'equilibre',nom:'Cuisson à cœur',art:'ideale',effet:'Attente et rendement équilibrés'},{id:'complete',nom:'Carbonisation complète',art:'complete',effet:'Très lente · +18 % de charbon',niv:4}],choix=el('div',{class:'scierie-organisations charbonniere-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artCharbonniere(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Charbonnière niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'Un ouvrier affecté surveille la meule même pendant l’attente. Elle mûrit seule jusqu’au seuil choisi, le cycle s’ouvre puis une nouvelle meule recommence : aucun clic n’est nécessaire.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),liste=el('div',{class:'scierie-chaines charbonniere-chaines'});for(const rid of disponibles)liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artCharbonniere,source:'meule'}));c.appendChild(liste);
  }

  function rendreTuilerieChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b),max=G.sechageMaxTuilerie(b),sec=s.sechage/max;
    c.appendChild(el('section',{class:'scierie-maitrise tuilerie-maitrise'},el('img',{src:artTuilerie('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE DE TUILERIE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:'×'+mult.toFixed(2)}),el('span',{text:'four'}))));
    const etat=s.temperature<45?'froid':(s.temperature>94?'surchauffe':(s.temperature>=68&&s.temperature<=90?'ideal':'cuisson'));
    const reglage=el('label',{class:'tuilerie-charge'},el('span',{text:'Densité du chargement'}),el('input',{type:'range',min:'30',max:'100',value:String(Math.round(s.charge)),oninput:e=>{s.charge=Number(e.target.value);e.target.nextSibling.textContent=Math.round(s.charge)+' %';},onchange:()=>{window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}}),el('b',{text:Math.round(s.charge)+' %'}),el('img',{src:artTuilerie(s.charge>70?'dense':'legere'),alt:''}));
    c.appendChild(el('section',{class:'tuilerie-four'},el('img',{src:artTuilerie(etat),alt:''}),el('div',{},el('div',{class:'rangee entre'},el('b',{text:'Pièces sèches sur claies'}),el('strong',{text:Math.floor(s.sechage)+' / '+max})),U.barre(sec,s.sechage<12?'rouge':'verte','Claies',s.sechage<12?'moulez une fournée':'réserve locale prête à cuire'),el('div',{class:'rangee entre tuilerie-jauge-titre'},el('b',{text:'Température du four'}),el('strong',{text:Math.round(s.temperature)+' %'})),U.barre(s.temperature/100,s.temperature>94?'rouge':(s.temperature>67?'or':''),'Four',s.temperature>96?'cuisson suspendue':'monte pendant les fournées'),reglage)));
    const strategies=[{id:'rapide',nom:'Cuisson vive',art:'cuisson',effet:'Cycles +20 % · lots plus petits'},{id:'equilibre',nom:'Four régulier',art:'ideal',effet:'Temps et rendement équilibrés'},{id:'dense',nom:'Fournée dense',art:'dense',effet:'+18 % de rendement · cuisson lente',niv:4}],choix=el('div',{class:'scierie-organisations tuilerie-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artTuilerie(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Tuilerie niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'La chaîne est volontairement en deux temps : des ouvriers moulent et sèchent les pièces, les autres alimentent le four. Une préparation en boucle suffit à réapprovisionner automatiquement toutes les cuissons.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),toutes=window.BAT[b.type].recettes||[],liste=el('div',{class:'scierie-chaines tuilerie-chaines'});for(const rid of toutes.filter(x=>disponibles.includes(x)))liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artTuilerie,source:rid==='preparer_fournee'?'claies':'four'}));for(const rid of toutes.filter(x=>!disponibles.includes(x)).slice(0,2))liste.appendChild(rendreLigneScierie(bid,rid,false,{art:artTuilerie,source:'four'}));c.appendChild(liste);
  }

  function rendrePoterieChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b),max=G.formesMaxPoterie(b);
    c.appendChild(el('section',{class:'scierie-maitrise poterie-maitrise'},el('img',{src:artPoterie('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE DE POTERIE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:'×'+mult.toFixed(2)}),el('span',{text:'tour'}))));
    const reglage=el('label',{class:'poterie-charge'},el('span',{text:'Charge du four'}),el('input',{type:'range',min:'30',max:'100',value:String(Math.round(s.charge)),oninput:e=>{s.charge=Number(e.target.value);e.target.nextSibling.textContent=Math.round(s.charge)+' %';},onchange:()=>{window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}}),el('b',{text:Math.round(s.charge)+' %'}),el('img',{src:artPoterie(s.charge>72?'empilement':'four'),alt:''}));
    c.appendChild(el('section',{class:'poterie-atelier'},el('img',{src:artPoterie(s.casse>32?'casse':(s.centrage>78?'parfaite':'formes')),alt:''}),el('div',{},el('div',{class:'rangee entre'},el('b',{text:'Formes sèches'}),el('strong',{text:Math.floor(s.formes)+' / '+max})),U.barre(s.formes/max,s.formes<8?'rouge':'verte','Claies',s.formes<8?'le four attend les tourneurs':'réserve prête'),el('div',{class:'rangee entre poterie-jauge-titre'},el('b',{text:'Régularité du geste'}),el('strong',{text:Math.round(s.centrage)+' %'})),U.barre(s.centrage/100,s.centrage<35?'rouge':'or','Centrage','progresse en pratiquant au tour'),el('div',{class:'rangee entre poterie-jauge-titre'},el('b',{text:'Casse récente'}),el('strong',{text:Math.round(s.casse)+' %'})),U.barre(s.casse/100,s.casse>42?'rouge':'','Casse','retombe lentement entre les lots'),reglage)));
    const strategies=[{id:'serie',nom:'Vaisselle en série',art:'pot',effet:'Pièces communes +16 % · geste rapide'},{id:'equilibre',nom:'Atelier équilibré',art:'formes',effet:'Séries et pièces fines équilibrées'},{id:'prestige',nom:'Pièces de prestige',art:'parfaite',effet:'Glaçures et ventes +24 % · lent',niv:4}],choix=el('div',{class:'scierie-organisations poterie-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artPoterie(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Poterie niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'Tourner produit immédiatement les pots communs et met de côté les formes les plus régulières. Les grandes cuissons prélèvent cette réserve ; trop charger augmente le rendement mais aussi la casse.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),toutes=window.BAT[b.type].recettes||[],liste=el('div',{class:'scierie-chaines poterie-chaines'});for(const rid of toutes.filter(x=>disponibles.includes(x)))liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artPoterie,source:['cuire_pots','fournee_gres'].includes(rid)?'four':'tour'}));for(const rid of toutes.filter(x=>!disponibles.includes(x)).slice(0,2))liste.appendChild(rendreLigneScierie(bid,rid,false,{art:artPoterie,source:'atelier'}));c.appendChild(liste);
  }

  function rendreVerrerieChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b),max=G.bainMaxVerrerie(b),ideal=s.politique==='continu'?75:(s.politique==='artistique'?91:84);
    c.appendChild(el('section',{class:'scierie-maitrise verrerie-maitrise'},el('img',{src:artVerrerie('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE VERRIÈRE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:'×'+mult.toFixed(2)}),el('span',{text:'four'}))));
    const etat=s.temperature<52?'froid':(s.temperature>96?'surchauffe':'ideal'),reglage=el('label',{class:'verrerie-tirage'},el('span',{text:'Tirage du four'}),el('input',{type:'range',min:'25',max:'100',value:String(Math.round(s.tirage)),oninput:e=>{s.tirage=Number(e.target.value);e.target.nextSibling.textContent=Math.round(s.tirage)+' %';},onchange:()=>{window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}}),el('b',{text:Math.round(s.tirage)+' %'}),el('img',{src:artVerrerie(s.tirage>82?'surchauffe':'four'),alt:''}));
    const ligneBain=el('div',{class:'rangee entre'},el('b',{text:'Bain de verre en fusion'}),el('strong',{text:Math.floor(s.bain)+' / '+max}));
    const ligneChaleur=el('div',{class:'rangee entre verrerie-jauge-titre'},el('b',{text:'Température'}),el('strong',{text:Math.round(s.temperature)+' % · cible '+ideal}));
    const ligneDefauts=el('div',{class:'rangee entre verrerie-jauge-titre'},el('b',{text:'Défauts du bain'}),el('strong',{text:Math.round(s.defauts)+' %'}));
    const corps=el('div',{},ligneBain,U.barre(s.bain/max,s.bain<12?'rouge':'verte','Bain',s.bain<12?'relancer la fusion':'matière chaude disponible'),ligneChaleur,U.barre(s.temperature/100,s.temperature>96?'rouge':'or','Four',s.temperature<55?'four à réchauffer':'inertie persistante'),ligneDefauts,U.barre(s.defauts/100,s.defauts>36?'rouge':'','Bulles','diminue lentement au repos'),reglage);
    c.appendChild(el('section',{class:'verrerie-four'},el('img',{src:artVerrerie(etat),alt:''}),corps));
    const strategies=[{id:'continu',nom:'Verre commun continu',art:'verre',effet:'Fusion +18 % · four moins chaud'},{id:'equilibre',nom:'Four régulier',art:'ideal',effet:'Bain et commandes équilibrés'},{id:'artistique',nom:'Atelier artistique',art:'vitrail',effet:'Vitraux et miroirs +25 % · lent',niv:4}],choix=el('div',{class:'scierie-organisations verrerie-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artVerrerie(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Verrerie niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'Fondre remplit le bain local ; fioles, miroirs et vitraux y puisent leur matière chaude. Le four conserve son inertie, donc une relève de fusion stabilise automatiquement les autres postes sans clic.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),toutes=window.BAT[b.type].recettes||[],liste=el('div',{class:'scierie-chaines verrerie-chaines'});for(const rid of toutes.filter(x=>disponibles.includes(x)))liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artVerrerie,source:rid==='souffler_verre'?'four':'banc'}));for(const rid of toutes.filter(x=>!disponibles.includes(x)).slice(0,2))liste.appendChild(rendreLigneScierie(bid,rid,false,{art:artVerrerie,source:'banc'}));c.appendChild(liste);
  }

  function rendreFonderieChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b),fam={ferreux:'Ferreux',cuivreux:'Cuivreux',precieux:'Précieux',mystique:'Mystique',propre:'Creuset propre'}[s.dernierMetal]||'Ferreux';
    c.appendChild(el('section',{class:'scierie-maitrise fonderie-maitrise'},el('img',{src:artFonderie('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE DE FONDERIE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:'×'+mult.toFixed(2)}),el('span',{text:'four'}))));
    const reglage=el('label',{class:'fonderie-tirage'},el('span',{text:'Tirage du haut-fourneau'}),el('input',{type:'range',min:'25',max:'100',value:String(Math.round(s.tirage)),oninput:e=>{s.tirage=Number(e.target.value);e.target.nextSibling.textContent=Math.round(s.tirage)+' %';},onchange:()=>{window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}}),el('b',{text:Math.round(s.tirage)+' %'}),el('img',{src:artFonderie('soufflet'),alt:''}));
    const corps=el('div',{},el('div',{class:'rangee entre'},el('b',{text:'Température du bain'}),el('strong',{text:Math.round(s.temperature)+' %'})),U.barre(s.temperature/100,s.temperature>97?'rouge':'or','Chaleur','dépend du tirage et des coulées'),el('div',{class:'rangee entre fonderie-jauge-titre'},el('b',{text:'Scories'}),el('strong',{text:Math.round(s.scories)+' %'})),U.barre(s.scories/100,s.scories>72?'rouge':'','Creuset',s.scories>=90?'coulées suspendues':'purge automatisable'),el('div',{class:'rangee entre fonderie-jauge-titre'},el('b',{text:'Contamination'}),el('strong',{text:Math.round(s.contamination)+' % · '+fam})),U.barre(s.contamination/100,s.contamination>45?'rouge':'','Bain','monte en changeant de famille'),reglage);
    c.appendChild(el('section',{class:'fonderie-four'},el('img',{src:artFonderie(s.scories>70?'scories':(s.contamination<8?'propre':'bain')),alt:''}),corps));
    const strategies=[{id:'recuperation',nom:'Récupération',art:'limaille',effet:'Limaille +30 % · four moins chaud'},{id:'equilibre',nom:'Coulées régulières',art:'bain',effet:'Tous les métaux équilibrés'},{id:'alliage',nom:'Maître des alliages',art:'mithril',effet:'Bronze, acier, mithril +22 %',niv:5}],choix=el('div',{class:'scierie-organisations fonderie-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artFonderie(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Fonderie niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'Enchaîner une même famille de métaux garde le bain propre. Changer brutalement de ferreux à précieux ou mystique crée de la contamination ; une purge en boucle nettoie automatiquement le creuset avant l’arrêt complet.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),toutes=window.BAT[b.type].recettes||[],liste=el('div',{class:'scierie-chaines fonderie-chaines'});for(const rid of toutes.filter(x=>disponibles.includes(x)))liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artFonderie,source:rid==='purger_four'?'entretien':'creuset'}));for(const rid of toutes.filter(x=>!disponibles.includes(x)).slice(0,2))liste.appendChild(rendreLigneScierie(bid,rid,false,{art:artFonderie,source:'creuset'}));c.appendChild(liste);
  }

  function rendreForgeChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b),ideal=s.politique==='entretien'?72:(s.politique==='arsenal'?90:82),travail=E().armee&&E().armee.forge;
    c.appendChild(el('section',{class:'scierie-maitrise forge-maitrise'},el('img',{src:artForge('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE DE FORGE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:'×'+mult.toFixed(2)}),el('span',{text:'atelier'}))));
    const etat=s.chaleur<52?'froid':(s.chaleur>96?'surchauffe':'ideal'),reglage=el('label',{class:'forge-tirage'},el('span',{text:'Tirage du foyer'}),el('input',{type:'range',min:'25',max:'100',value:String(Math.round(s.tirage)),oninput:e=>{s.tirage=Number(e.target.value);e.target.nextSibling.textContent=Math.round(s.tirage)+' %';},onchange:()=>{window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}}),el('b',{text:Math.round(s.tirage)+' %'}),el('img',{src:artForge('foyer'),alt:''}));
    const corps=el('div',{},el('div',{class:'rangee entre'},el('b',{text:'Chaleur du foyer'}),el('strong',{text:Math.round(s.chaleur)+' % · cible '+ideal})),U.barre(s.chaleur/100,s.chaleur>97?'rouge':'or','Foyer','partagé avec les commandes d’aventure'),el('div',{class:'rangee entre forge-jauge-titre'},el('b',{text:'Rythme de frappe'}),el('strong',{text:Math.round(s.rythme)+' %'})),U.barre(s.rythme/100,s.rythme>70?'verte':'','Cadence','progresse avec les séries stables'),el('div',{class:'rangee entre forge-jauge-titre'},el('b',{text:'Précision'}),el('strong',{text:Math.round(s.precision)+' %'})),U.barre(s.precision/100,s.precision>70?'verte':'','Geste',travail?'une pièce d’aventure est en cours':'les commandes fines la font progresser'),reglage);
    c.appendChild(el('section',{class:'forge-foyer'},el('img',{src:artForge(etat),alt:''}),corps));
    const strategies=[{id:'entretien',nom:'Service du bourg',art:'outil',effet:'Clous et outils +20 % · foyer doux'},{id:'equilibre',nom:'Forge polyvalente',art:'enclume',effet:'Toutes les commandes équilibrées'},{id:'arsenal',nom:'Arsenal de campagne',art:'arme',effet:'Armes +24 % · équipement accéléré',niv:4}],choix=el('div',{class:'scierie-organisations forge-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artForge(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Forge niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'Le foyer, le rythme et la précision servent aussi aux 40 paliers de l’onglet Arsenal. La trempe et le renforcement restent dans leurs onglets dédiés ; cette page pilote seulement l’écosystème commun de la forge.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),toutes=window.BAT[b.type].recettes||[],liste=el('div',{class:'scierie-chaines forge-chaines'});for(const rid of toutes.filter(x=>disponibles.includes(x)))liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artForge,source:rid==='martinet_barres'?'martinet':'enclume'}));for(const rid of toutes.filter(x=>!disponibles.includes(x)).slice(0,2))liste.appendChild(rendreLigneScierie(bid,rid,false,{art:artForge,source:'enclume'}));c.appendChild(liste);
  }

  function rendreArmurerieChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b);
    c.appendChild(el('section',{class:'scierie-maitrise armurerie-maitrise'},el('img',{src:artArmurerie('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE D’ARMURERIE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:'×'+mult.toFixed(2)}),el('span',{text:'atelier'}))));
    const reglage=el('label',{class:'armurerie-standard'},el('span',{text:'Standard mobilité ↔ protection'}),el('input',{type:'range',min:'0',max:'100',value:String(Math.round(s.standard)),oninput:e=>{s.standard=Number(e.target.value);e.target.nextSibling.textContent=Math.round(s.standard)+' %';},onchange:()=>{window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}}),el('b',{text:Math.round(s.standard)+' %'}),el('img',{src:artArmurerie(s.standard<38?'leger':(s.standard>68?'lourd':'equilibre')),alt:''}));
    const corps=el('div',{},el('div',{class:'rangee entre'},el('b',{text:'Ajustement des patrons'}),el('strong',{text:Math.round(s.ajustement)+' %'})),U.barre(s.ajustement/100,s.ajustement>72?'verte':'or','Mesures','progresse avec chaque assemblage'),el('div',{class:'rangee entre armurerie-jauge-titre'},el('b',{text:'Chutes sur les établis'}),el('strong',{text:Math.round(s.chutes)+' %'})),U.barre(s.chutes/100,s.chutes>72?'rouge':'','Chutes',s.chutes>=92?'assemblages suspendus':'le tri rend de la limaille'),reglage);
    c.appendChild(el('section',{class:'armurerie-atelier'},el('img',{src:artArmurerie(s.chutes>70?'chutes':(s.ajustement>75?'heaume':'mannequin')),alt:''}),corps));
    const strategies=[{id:'serie',nom:'Équipement de colonne',art:'commandes',effet:'Harnois et écus +22 %'},{id:'equilibre',nom:'Atelier polyvalent',art:'equilibre',effet:'Toutes les pièces équilibrées'},{id:'protection',nom:'Protection lourde',art:'lourd',effet:'Écailles et maille +26 % · lent',niv:4},{id:'mobilite',nom:'Coupe mobile',art:'leger',effet:'Maille et écus +16 % · gestes précis',niv:3}],choix=el('div',{class:'scierie-organisations armurerie-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artArmurerie(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Armurerie niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'Les séries affinent les patrons de taille. Les chutes s’accumulent puis repartent à la fonderie grâce à une activité de tri en boucle ; l’atelier ne demande donc aucun vidage manuel.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),toutes=window.BAT[b.type].recettes||[],liste=el('div',{class:'scierie-chaines armurerie-chaines'});for(const rid of toutes.filter(x=>disponibles.includes(x)))liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artArmurerie,source:rid==='recycler_chutes_armure'?'tri':'etabli'}));for(const rid of toutes.filter(x=>!disponibles.includes(x)).slice(0,2))liste.appendChild(rendreLigneScierie(bid,rid,false,{art:artArmurerie,source:'etabli'}));c.appendChild(liste);
  }

  function rendreOrfevreChaine(c,bid){
    const b=E().bat[bid],G=window.EcosystemesBatiments;if(!b||!G)return;
    const m=window.Jeu.maitriseAtelier(b),s=G.personnel(b).signature,mult=G.facteurSignature(b);
    c.appendChild(el('section',{class:'scierie-maitrise orfevre-maitrise'},el('img',{src:artOrfevre('maitrise'),alt:''}),el('div',{class:'scierie-maitrise-corps'},el('div',{class:'rangee entre'},el('span',{},el('i',{text:'MAÎTRISE D’ORFÈVRERIE'}),el('b',{text:'Rang '+m.niveau})),el('strong',{text:'+'+Math.round(m.bonus*100)+' %'})),el('div',{class:'scierie-maitrise-jauge'},el('i',{style:'width:'+Math.round(m.pct*100)+'%'})),el('small',{text:U.fmt(m.dans)+' / '+U.fmt(m.pour)+' xp avant le rang suivant'})),el('div',{class:'scierie-effectif'},el('b',{text:'×'+mult.toFixed(2)}),el('span',{text:'établi'}))));
    const recRef=window.REC[s.politique==='monnaie'?'monnayer':(s.politique==='audacieux'?'sertir':'joaillerie')],risque=Math.round(G.risqueOrfevre(b,recRef)*100),reglage=el('label',{class:'orfevre-tension'},el('span',{text:'Tension du sertissage'}),el('input',{type:'range',min:'10',max:'95',value:String(Math.round(s.tension)),oninput:e=>{s.tension=Number(e.target.value);e.target.nextSibling.textContent=Math.round(s.tension)+' %';},onchange:()=>{window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}}),el('b',{text:Math.round(s.tension)+' %'}),el('img',{src:artOrfevre(s.tension>70?'audacieux':(s.tension<35?'prudent':'equilibre')),alt:''}));
    const corps=el('div',{},el('div',{class:'rangee entre'},el('b',{text:'Précision des gestes'}),el('strong',{text:Math.round(s.precision)+' %'})),U.barre(s.precision/100,s.precision>76?'verte':'or','Précision','progresse avec les réussites'),el('div',{class:'rangee entre orfevre-jauge-titre'},el('b',{text:'Éclats sur l’établi'}),el('strong',{text:Math.round(s.eclats)+' %'})),U.barre(s.eclats/100,s.eclats>70?'rouge':'','Éclats',s.eclats>=90?'travail suspendu':'polissage automatisable'),el('div',{class:'orfevre-risque'},el('img',{src:artOrfevre(risque>35?'casse':'sertissage'),alt:''}),el('span',{text:'Risque indicatif sur la commande ciblée'}),el('b',{text:risque+' %'})),reglage);
    c.appendChild(el('section',{class:'orfevre-etabli'},el('img',{src:artOrfevre(s.eclats>68?'casse':(s.precision>76?'bijou':'balance')),alt:''}),corps));
    const strategies=[{id:'monnaie',nom:'Monnaie sûre',art:'monnaie',effet:'Écus +20 % · risque minimal'},{id:'prudent',nom:'Sertissage prudent',art:'prudent',effet:'Risque réduit · valeur modérée'},{id:'equilibre',nom:'Maison équilibrée',art:'equilibre',effet:'Risque et valeur équilibrés'},{id:'audacieux',nom:'Pièce d’exception',art:'audacieux',effet:'Bijoux +26 % · risque élevé',niv:5}],choix=el('div',{class:'scierie-organisations orfevre-strategies'});
    for(const p of strategies){const verrou=b.niv<(p.niv||1);choix.appendChild(el('button',{class:'scierie-organisation'+(s.politique===p.id?' active':''),disabled:verrou,onclick:()=>{s.politique=p.id;window.Etat.prevenir('poste',{bat:bid});rafraichirVillage();}},el('img',{src:artOrfevre(p.art),alt:''}),el('span',{},el('b',{text:p.nom}),el('i',{text:verrou?'Orfèvre niveau '+p.niv:p.effet})),el('strong',{text:s.politique===p.id?'ACTIVE':(verrou?'VERROUILLÉ':'CHOISIR')})))}c.appendChild(choix);
    c.appendChild(el('div',{class:'scierie-consigne',text:'La tension augmente la valeur potentielle mais aussi les défauts. Une relève de polissage en boucle attend que l’établi en ait besoin, récupère la précision et évite de surveiller chaque gemme.'}));
    const disponibles=window.BatUtil.recettesDe(b.type,b.niv,b),toutes=window.BAT[b.type].recettes||[],liste=el('div',{class:'scierie-chaines orfevre-chaines'});for(const rid of toutes.filter(x=>disponibles.includes(x)))liste.appendChild(rendreLigneScierie(bid,rid,true,{art:artOrfevre,source:rid==='polir_outils_orfevre'?'entretien':'établi'}));for(const rid of toutes.filter(x=>!disponibles.includes(x)).slice(0,2))liste.appendChild(rendreLigneScierie(bid,rid,false,{art:artOrfevre,source:'établi'}));c.appendChild(liste);
  }
  ...
  function ongletsBatiment(bid) {
    ...
    if (bb.type === 'scierie') {
      ...
      return ong;
    } else if(bb.type==='mine'){
      ajouter('chaine','Galeries',c=>rendreMineChaine(c,bid),1,'bleu',artMine('mine'));
      ajouter('niveau','Descendre',c=>rendreNiveau(c,bid),1,'jaune',artMine('profondeur'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('mine'):imageRes('outil'));
      ajouter('personnel','Mineurs',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artMine('maitrise'));
      if(window.RaffUtil&&window.RaffUtil.pourBat(bb.type).length)ajouter('annexe','Laverie',c=>rendreAnnexes(c,bid),3,'orange',artMine('laverie'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artMine,arts:{repos:'galerie',lampes:'lampe',casiers:'soutien',monte:'mine'}}),4,'vert',artMine('lampe'));
      return ong;
    } else if(bb.type==='charbonniere'){
      ajouter('chaine','Meule',c=>rendreCharbonniereChaine(c,bid),1,'bleu',artCharbonniere('meule'));
      ajouter('niveau','Agrandir',c=>rendreNiveau(c,bid),1,'jaune',artCharbonniere('complete'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('feu'):imageRes('outil'));
      ajouter('personnel','Veilleurs',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artCharbonniere('maitrise'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artCharbonniere,arts:{hutte:'meule',masque:'froide',eau:'incendie',auvent:'sceller'}}),4,'vert',artCharbonniere('sceller'));
      return ong;
    } else if(bb.type==='tuilerie'){
      ajouter('chaine','Four',c=>rendreTuilerieChaine(c,bid),1,'bleu',artTuilerie('four'));
      ajouter('niveau','Agrandir',c=>rendreNiveau(c,bid),1,'jaune',artTuilerie('sechoir'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('feu'):imageRes('outil'));
      ajouter('personnel','Tuiliers',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artTuilerie('maitrise'));
      if(window.RaffUtil&&window.RaffUtil.pourBat(bb.type).length)ajouter('annexe','Chaufour',c=>rendreAnnexes(c,bid),3,'orange',artTuilerie('cuisson'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artTuilerie,arts:{auvent:'sechoir',masques:'refroidissement',table:'moule',securite:'economie'}}),4,'vert',artTuilerie('sechoir'));
      return ong;
    } else if(bb.type==='poterie'){
      ajouter('chaine','Atelier',c=>rendrePoterieChaine(c,bid),1,'bleu',artPoterie('tour'));
      ajouter('niveau','Agrandir',c=>rendreNiveau(c,bid),1,'jaune',artPoterie('sechoir'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('poterie'):imageRes('outil'));
      ajouter('personnel','Potiers',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artPoterie('maitrise'));
      if(window.RaffUtil&&window.RaffUtil.pourBat(bb.type).length)ajouter('annexe','Tour à pied',c=>rendreAnnexes(c,bid),3,'orange',artPoterie('tour'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artPoterie,arts:{siege:'tour',lavage:'glacure',claies:'sechoir',lumiere:'parfaite'}}),4,'vert',artPoterie('outils'));
      return ong;
    } else if(bb.type==='verrerie'){
      ajouter('chaine','Four',c=>rendreVerrerieChaine(c,bid),1,'bleu',artVerrerie('four'));
      ajouter('niveau','Agrandir',c=>rendreNiveau(c,bid),1,'jaune',artVerrerie('creusets'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('feu'):imageRes('outil'));
      ajouter('personnel','Verriers',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artVerrerie('maitrise'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artVerrerie,arts:{ecran:'four',eau:'recuit',lunettes:'miroir',banc:'canne'}}),4,'vert',artVerrerie('recuit'));
      return ong;
    } else if(bb.type==='fonderie'){
      ajouter('chaine','Coulées',c=>rendreFonderieChaine(c,bid),1,'bleu',artFonderie('four'));
      ajouter('niveau','Agrandir',c=>rendreNiveau(c,bid),1,'jaune',artFonderie('moules'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('feu'):imageRes('outil'));
      ajouter('personnel','Fondeurs',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artFonderie('maitrise'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artFonderie,arts:{ecran:'four',masques:'scories',palan:'moules',douche:'purge'}}),4,'vert',artFonderie('propre'));
      return ong;
    } else if(bb.type==='forge'){
      ajouter('chaine','Foyer',c=>rendreForgeChaine(c,bid),1,'bleu',artForge('foyer'));
      if(window.Armee)ajouter('arsenal','Arsenal',c=>rendreArsenal(c,bid),1,'orange',artForge('arme'));
      ajouter('niveau','Agrandir',c=>rendreNiveau(c,bid),1,'jaune',artForge('enclume'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('forge'):imageRes('outil'));
      if(window.UICompagnie){ajouter('renfort','Renforcement',c=>window.UICompagnie.rendreForgeRenfort(c,bid),2,'vert',imageRes('armure'));ajouter('trempe','Trempe',c=>window.UICompagnie.rendreForgeTrempe(c,bid),3,'orange',artForge('trempe'));}
      ajouter('personnel','Forgerons',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artForge('maitrise'));
      if(window.RaffUtil&&window.RaffUtil.pourBat(bb.type).length)ajouter('annexe','Martinet',c=>rendreAnnexes(c,bid),3,'orange',artForge('martinet'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artForge,arts:{tabouret:'enclume',eau:'trempe',rangement:'commandes',hotte:'foyer'}}),4,'vert',artForge('precision'));
      return ong;
    } else if(bb.type==='armurerie'){
      ajouter('chaine','Assemblage',c=>rendreArmurerieChaine(c,bid),1,'bleu',artArmurerie('harnois'));
      ajouter('niveau','Agrandir',c=>rendreNiveau(c,bid),1,'jaune',artArmurerie('mannequin'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('forge'):imageRes('outil'));
      ajouter('personnel','Armuriers',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artArmurerie('maitrise'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artArmurerie,arts:{siege:'rivets',lumiere:'heaume',mannequin:'mannequin',rangement:'patron'}}),4,'vert',artArmurerie('mesures'));
      return ong;
    } else if(bb.type==='orfevre'){
      ajouter('chaine','Établi',c=>rendreOrfevreChaine(c,bid),1,'bleu',artOrfevre('balance'));
      ajouter('niveau','Agrandir',c=>rendreNiveau(c,bid),1,'jaune',artOrfevre('coffre'));
      ajouter('outil','Outillage',c=>rendreOutil(c,bid),2,'vert',window.OutilUtil?window.OutilUtil.imageMetier('forge'):imageRes('outil'));
      ajouter('personnel','Orfèvres',c=>rendrePersonnelEcosysteme(c,bid),3,'bleu',artOrfevre('maitrise'));
      ajouter('confort','Confort',c=>rendreConfortEcosysteme(c,bid,{art:artOrfevre,arts:{siege:'balance',lumiere:'sertissage',coffre:'coffre',aspiration:'tri'}}),4,'vert',artOrfevre('polissage'));
      return ong;
